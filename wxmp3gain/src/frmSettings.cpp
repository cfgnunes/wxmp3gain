...
: configBase(configBase)
{
    ...
    chkAutoLower = new wxCheckBox(Panel6, ID_CHECKBOX3, _("Automatically lower gain to not clip audio"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX3"));
    ...
    lblConstantGain = new wxStaticText(Panel3, ID_STATICTEXT1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
...
void frmSettings::OnsldConstantGainCmdSliderUpdated(wxScrollEvent& event)
{
    ...
    lblConstantGain->SetLabel(wxString::Format(_T("%+i"), intGain) + _T(" (") + wxString::Format(_T("%+.1f"), intGain * (5.0 * log10(2.0))) + _T(" dB)"));
}
